...
c1 = c;
s1= s;
q1 = "select * from emp where id ='" + empid +'";
try{
...
try{
    if(rs1.next()){
         t1.setText(rsl.getString(2));
         t5.setText(rsl.getString(4));
         ta1.setText(rsl.getString(7));
         t6.setText(rsl.getString(8));
          t8.setText(rsl.getString(9));
   ...
   public void actionPerformed(ActionEvent e){
    ...
    if(!a1.equals("") &&!a7.equals("") &&!a6.equals("") &&!a6.equals("")){
       if(e.getSource() ==b1){
          ...
          String q = "update emp set name ='", + a1 +'",gemder='" + a2 "',age='" + a3 "',age=a2 "'+ hobbies='" +a4 "',phone='" a5 "'+ address='" +a7 '"+ a8+ '",'" +a9 '"+ a10+ "' ";
          s.executeUpdate(q);
          setVisible(false);
          new View();
